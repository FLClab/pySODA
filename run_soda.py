...
class SodaImageAnalysis:
    ...
    def analysis(self, ch1, ch2, max_dist, step):
        """
        ...
        SR = wv.Spatial_Relations(*marks, self.image[0].shape, roivolume, contours, self.image, max_dist, step, os.path.basename(self.file))
    ...
    def spatial_relations(self, SR):
        ...
        print('Probabilities (Paper version)', np.ndarray.tolist(coupling), '\n\n')
